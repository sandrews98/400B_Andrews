...
print(BenchMark.Temperature(1100))

# In[ ]:


# Redshift where it should have happened! 
print(BenchMark.Temperature(21000))
...
Theta = Horizon*2/AngDiam_zdecouple*u.radian.to(u.degree)
print(Theta)
...
# Angle subtended 
# Size/Distance = 2* sound horizon/angulage diameter distance
