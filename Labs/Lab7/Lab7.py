...
def density_contour(xdata, ydata, nbins_x, nbins_y, ax=None, **contour_kwargs):
    #**kwargs means to expect keywords but we don't know them yet
    ...
    """
    #setting up a histogram so we can create contours
    ...
    strs = ['0.68','0.80', '0.9', '0.95', '0.99'][::-1]
...
# ADD HERE
plt.hist2d(rnew[:,0], rnew[:,2], bins = 500, norm = LogNorm(), cmap='magma')
...
# ADD HERE
plt.hist2d(rnew[:,0], rnew[:,1], bins = 500, norm = LogNorm(), cmap='magma')
...
# ADD HERE
plt.hist2d(rnew[:,0], vnew[:,1], bins = 500, norm=LogNorm())
