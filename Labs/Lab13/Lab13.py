...
print(BenchMark.LookBackTime(2.7))

print(BenchMark.LookBackTime(6.6))
...
print(1/BenchMark.HubbleParameter(0).to(u.km/u.km/u.Gyr))
...
print(BenchMark.ComovingDistance(1000))

print(DeSitter.ComovingDistance(1000))
...
print(BenchMark.ProperDistance(0, 1000)/(BenchMark.ProperDistance(2, 1000)))
...
print(BenchMark.LuminosityDistance(1.095))

print(BenchMark.ProperDistance(0, 1.095))
