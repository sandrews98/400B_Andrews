...
z_0 = BenchMark.HubbleParameter(0)
print(z_0)
print(BenchMark.Ho)
...
z1 = BenchMark.HubbleParameter(1)
print(z1)
...
# 
print(BenchMark.OmegaM_Z(3.75e3))
print(BenchMark.OmegaR_Z(3.75e3))
# 
...
# 
# 
print(BenchMark.OmegaM_Z(0.3))
print(BenchMark.OmegaL_Z(0.3))
